...
const APP_VERSION = '20260614-12'; // = BUILD_VERSION (сервер) и ?v= в index.html; бампать через scripts/bump-version.mjs
...
inventoryEl.addEventListener('pointerdown', (e) => {
  ...
  invDrag = { cardIndex: i, ghost: null, srcEl: cardEl, startX: e.clientX, startY: e.clientY, started: false };
});
