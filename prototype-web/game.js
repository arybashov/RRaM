...
const APP_VERSION = '20260625-10'; // = BUILD_VERSION (сервер) и ?v= в index.html; бампать через scripts/bump-version.mjs
...
function renderInventory() {
  ...
  const aboveCards = beastInfo + combatStatsInfo + placedTerrainInfo;
